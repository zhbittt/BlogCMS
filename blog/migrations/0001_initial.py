# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-26 07:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.FileField(default='/media/avatar/default.png', upload_to='avatar', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_data', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('up_count', models.IntegerField(default=0)),
                ('down_count', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=32, verbose_name='技术分类')),
            ],
        ),
        migrations.CreateModel(
            name='SiteCategory',
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=32, verbose_name='网站分类')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
